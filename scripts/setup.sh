...
echo ""
echo "2. Start local Supabase (recommended):"
echo "   npm run supabase:start"
echo "   Then visit Supabase Studio: http://127.0.0.1:54323"
echo ""
echo "3. Start the development server:"
echo "   npm run dev"
echo "   Then visit your app: http://localhost:3000"
echo ""
...
echo "   - Local: npm run supabase:start (full Supabase stack)"
echo "   - Cloud: Use your own Supabase project"
echo ""
echo "Good luck! 🚀"