    ...
    <div className="space-y-8">
      ...
      <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-6 mt-8">
        ...
        <div className="space-y-2 text-sm text-yellow-700">
          <p>• Copy <code className="bg-yellow-100 px-1 rounded">.env.example</code> to <code className="bg-yellow-100 px-1 rounded">.env.local</code> and add your OpenAI API key</p>
          <p>• Run <code className="bg-yellow-100 px-1 rounded">npm run dev</code> to start the development server</p>
